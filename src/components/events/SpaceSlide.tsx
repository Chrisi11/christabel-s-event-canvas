...
const spaceDetails = [
  { label: "Standing Capacity", value: "150" },
  { label: "Seated Capacity", value: "80" },
  { label: "Bar Area", value: "40" },
  { label: "Stage Area", value: "Live Ready" },
];
    ...
    <SectionWrapper className="bg-background">
      <div className="max-w-6xl w-full">
        ...
        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-foreground mb-16 text-center">
          A Theatre of <span className="italic text-gradient-gold">Intimacy</span>
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {atmosphereDescriptors.map((descriptor, index) => (
            <motion.span
              key={descriptor}
