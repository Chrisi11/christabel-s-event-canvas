...
export const AudienceSlide = () => {
  return <SectionWrapper className="bg-gradient-section">
      <div className="max-w-4xl text-center">
        ...
        <p className="text-muted-foreground font-body text-lg md:text-xl leading-relaxed mb-12 max-w-2xl mx-auto">A highly engaged late-night audience with strong cultural influence. From Marvel movie directors to heritage rockstars, our members are the city's most connected individuals from the film, music and media industries.
      </p>
