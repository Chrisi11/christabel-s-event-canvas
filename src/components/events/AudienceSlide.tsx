    ...
    <SectionWrapper className="bg-gradient-section">
      <div className="max-w-4xl text-center">
        ...
        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-foreground mb-10">
          The <span className="italic text-gradient-gold">Nightkey</span> Community
        </h2>

        <p className="text-muted-foreground font-body text-lg md:text-xl leading-relaxed mb-12 max-w-2xl mx-auto">
          A highly engaged late-night audience with strong cultural influence. 
          Our members are the city's most connected creatives—those who set 
          the agenda, not follow it.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="text-center"
          >
            <span className="block text-5xl md:text-6xl font-display text-gold mb-2">2K+</span>
