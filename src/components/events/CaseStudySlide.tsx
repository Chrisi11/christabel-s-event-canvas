...
const outcomes = [
  { metric: "150+", label: "Guests Attended" },
  { metric: "50K+", label: "Social Impressions" },
  { metric: "12", label: "Press Mentions" },
  { metric: "100%", label: "Brand Recall" },
];
      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <img 
              src={cocktailBar} 
              alt="Case Study - Coracho Tequila" 
          ...
          >
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-2">
              Christabel's <span className="text-gold">×</span> Coracho Tequila
            </h2>
            <p className="text-muted-foreground font-body mb-8">Winter 2024</p>

            <div className="space-y-6 mb-10">
              <div>
                <h4 className="font-body text-sm text-gold tracking-widest uppercase mb-2">Objective</h4>
                <p className="text-muted-foreground font-body">
                  Launch Coracho's premium tequila range to London's taste-making crowd 
              ...
              <div>
                ...
                <p className="text-muted-foreground font-body">
                  Full cocktail menu takeover featuring bespoke creations, live acoustic 
                  performance, guided tasting by Brett Watterton, and exclusive member access.
                </p>
              </div>
            </div>
