...
const reasons = ["Discreet but influential", "Cultural credibility", "Late-night energy", "Highly curated guestlist", "Not a hire space — a hosted experience", "London's creative heartbeat"];
