      ...
      <div className="max-w-6xl w-full">
        ...
        >
          ...
          <p className="text-muted-foreground font-body leading-relaxed">
            With global experience as a bar founder and consultant, Brett curates 
            story-led cocktail programming that transforms each evening into a 
            sensory journey.
          </p>
        </motion.div>
      </div>
