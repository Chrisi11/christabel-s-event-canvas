...
const productionServices = [
  ...
  },
  {
    icon: Users,
    title: "Staffing",
    description: "Professional bar, floor, and security teams"
  },
  {
    icon: Volume2,
    title: "Sound & Lighting",
    description: "State-of-the-art AV equipment and technicians"
  },
  {
    icon: ClipboardList,
    title: "Guestlist Management",
    description: "Curated door policy and RSVP handling"
  },
  {
    icon: Clock,
    title: "Run of Show",
    description: "Detailed timeline planning and execution"
  },
  {
    icon: Shield,
    title: "Security",
...
export const EventProductionSlide = () => {
  return (
    <SectionWrapper className="bg-background">
      <div className="max-w-5xl w-full">
        ...
        <h2 className="font-display text-4xl md:text-5xl lg:text-6xl text-foreground mb-6 text-center">
          Event <span className="italic text-gradient-gold">Production</span>
        </h2>

        <p className="text-muted-foreground font-body text-lg text-center mb-16 max-w-2xl mx-auto">
          We understand the demands of agency and brand events. Our team provides comprehensive production support to ensure flawless execution.
        </p>
